...
class HighlightView {
 ...
 private void init() {
     ...
     mResizeDrawableWidth = resources.getDrawable(ResourceUtil.getDrawableId(mContext.getContext(),"camera_crop_width"));
     mResizeDrawableHeight = resources.getDrawable(ResourceUtil.getDrawableId(mContext.getContext(),"camera_crop_height"));
     mResizeDrawableDiagonal = resources.getDrawable(ResourceUtil.getDrawableId(mContext.getContext(),"indicator_autocrop"));
 }
