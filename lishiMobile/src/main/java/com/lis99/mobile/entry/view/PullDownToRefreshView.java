...
public class PullDownToRefreshView extends LinearLayout {
	...
	public PullDownToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
...
//		mHeaderImageView.setVisibility(View.VISIBLE);
		mHeaderImageView.setImageResource(R.drawable.head_arrow);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(PullDownToRefreshView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(PullDownToRefreshView view);
	}
}
