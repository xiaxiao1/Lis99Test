...
public class LsWendaCommentActivity extends ActivityPattern {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ls_wenda_comment);
	...
	private class CommentListAdapter extends BaseAdapter {
		...
		public CommentListAdapter() {
			inflater = LayoutInflater.from(LsWendaCommentActivity.this);
		}
