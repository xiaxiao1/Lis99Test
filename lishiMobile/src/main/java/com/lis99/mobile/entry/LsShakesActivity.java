...
public class LsShakesActivity extends ActivityPattern implements
		IWXAPIEventHandler {
...
//	private LsControllShake mShaker;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ls_qiang_youhui);
		...
		initData();
		/*
		mShaker = new LsControllShake(this);
		...
		mShaker.setOnShakeListener(new OnShakeListener() {
			public void onShake() {
				...
				if (murl.equals("http://m.lis99.com/qiangyouhui/activity")) {
					...
					webview.loadUrl("javascript:shake()");
				}
			}
		});
		*/
...
//		mShaker.pause();
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case 0:
							...
							LsWeiboSina.getInstance(LsShakesActivity.this)
						...
						case 1:
							...
							LsWeiboWeixin
									.getInstance(LsShakesActivity.this)
									.getApi()
									.handleIntent(getIntent(),
											LsShakesActivity.this);
							LsWeiboWeixin.getInstance(LsShakesActivity.this)
						...
						case 3:
							...
							// 支持传多个imageUrl
							tencent.shareToQzone(LsShakesActivity.this, params,
									new IUiListener() {
						...
						case 4:
							...
							LsWeiboTencent.getInstance(LsShakesActivity.this)
	...
	HttpCallback mCallBack = new HttpCallback() {
		...
		public void onResult(Object object) {
			...
			if (result != null && result.isSuccess()) {
				Toast.makeText(LsShakesActivity.this, "分享成功",
						Toast.LENGTH_SHORT).show();
				webview.loadUrl("javascript:shareCallback('tweibo')");
			} else {
				Toast.makeText(LsShakesActivity.this, "分享失败",
						Toast.LENGTH_SHORT).show();
			}
		}
	};// 回调函数
	...
	public void onResponse(BaseResponse arg0) {
		...
		case WBConstants.ErrorCode.ERR_OK:
			Toast.makeText(LsShakesActivity.this, "分享成功", Toast.LENGTH_LONG)
					.show();
			webview.loadUrl("javascript:shareCallback('weibo')");
			break;
		case WBConstants.ErrorCode.ERR_CANCEL:
			Toast.makeText(LsShakesActivity.this, "取消分享", Toast.LENGTH_LONG)
					.show();
			break;
		case WBConstants.ErrorCode.ERR_FAIL:
			Toast.makeText(LsShakesActivity.this,
