...
public class ZhuangbeiCommentActivity extends ActivityPattern {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ls_zhuangbei_comment);
	...
	private void getCommentList(String id) {
		String url = C.MAIN_COMMENTLIST_URL + C.MODULE_TYPE_ZHUANGBEI + "/" +id+ "/" +"0" +"/"+10+"/" + "desc";
	...
	private class CommentListAdapter extends BaseAdapter {
		...
		public CommentListAdapter() {
			inflater = LayoutInflater.from(ZhuangbeiCommentActivity.this);
		}
