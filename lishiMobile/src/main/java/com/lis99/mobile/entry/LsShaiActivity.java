...
public class LsShaiActivity extends ActivityPattern implements OnViewChangeListener,GestureDetector.OnGestureListener, OnItemClickListener{
			...
			public boolean onPreDraw() {
				if (!hasMeasured) {
					window_width = getWindowManager().getDefaultDisplay()
							.getWidth();
					MAX_WIDTH = layout_left.getWidth()-(StringUtil.getXY(LsShaiActivity.this)[0]/8);
					RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) layout_right
							.getLayoutParams();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		try {
			...
			case C.PHOTO_PICKED_WITH_DATA:
				...
				bitmap = BitmapUtil.getThumbnail(photo_uri,LsShaiActivity.this);
			...
			case C.CAMERA_WITH_DATA:
				...
				bitmap =  BitmapUtil.getThumbnail(file,LsShaiActivity.this);
