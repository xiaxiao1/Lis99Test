...
public class LSClubTopicSeriesLineDetailAdapter extends MyBaseAdapter {
    ...
    public LSClubTopicSeriesLineDetailAdapter(Activity c, ArrayList listItem) {
        super(c, listItem);
    }
    ...
    public View setView(int i, View view, ViewGroup viewGroup) {
        ...
        ClubTopicActiveSeriesLineMainModel.ActivitydetailEntity item = (ClubTopicActiveSeriesLineMainModel.ActivitydetailEntity) getItem(i);
        ...
        if (!TextUtils.isEmpty(item.images))
        {
            ...
            getWidth(viewHolder.contentImageView, viewHolder.iv_load, item.images);
        }
