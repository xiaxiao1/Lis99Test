...
//        tv.setTextColor(getResources().getColor(R.color.text_color_green));
    ...
    private void selectText ( TextView tv )
    {
        tv.setTextColor(getResources().getColor(R.color.text_color_green));
    }

    private void unSelectText ( TextView tv )
    {
        tv.setTextColor(getResources().getColor(R.color.text_color_black));
    }
