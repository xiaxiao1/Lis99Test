...
public class DestinationFragnmentString extends LSFragment {

    private View view;
    private ListView exList;
    private DestinationStringAdapter adapter;
    private String id;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = View.inflate(getActivity(), R.layout.destination_info_string, null);
    ...
    private void getList ()
    {
        ...
        LSRequestManager.getInstance().getDestinationTwoList(d, new CallBack() {
            ...
            public void handler(MyTask mTask) {
                ...
                adapter = new DestinationStringAdapter(getActivity(), model.destlist);
