...
public class KFCommon {
    ...
    public static JSONObject getMessageExtFromPicture(String titleOrder, String imgUrl, String topicId, String price, String title, String topicUrl) {
...
//                "2015早春新款高腰复古牛仔裙", "https://www.baidu.com/img/bdlogo.png", "http://www.baidu.com");
        OrderMessageEntity entity1 = new OrderMessageEntity(1, titleOrder, "帖子编号："+topicId, "￥"+price,
