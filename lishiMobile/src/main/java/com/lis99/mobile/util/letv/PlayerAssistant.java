...
public class PlayerAssistant {
    ...
    public static void checkActionLiveStatus(ISplayer player, LiveStatusCallback liveStateCallback) {
        ...
        if (context != null && context.getActionInfo() != null) {
            LiveStatusManager.getActiveLiveStatus(context.getActionInfo().getActivityId(),
                    context.getLiveId(), context.getStreamId(), context.getContext(), context
                            .getJsProxy(), liveStateCallback);
        }
    }
