...
//        requestActionConfig();
    ...
    private void informFuction() {
        if (informDialog == null) {
            ...
            // 确认按钮
            view.findViewById(ReUtils.getId(context, "btn_confirm_inform")).setOnClickListener(new View.OnClickListener() {
            ...
            // 取消按钮
            view.findViewById(ReUtils.getId(context, "btn_cancel_inform")).setOnClickListener(new View.OnClickListener() {
